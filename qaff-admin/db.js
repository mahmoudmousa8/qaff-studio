...
const createClient = db.prepare(`
  INSERT INTO clients (name, container_id, container_name, port, slots, storage_gb, volume_name, status)
  VALUES (@name, @container_id, @container_name, @port, @slots, @storage_gb, @volume_name, 'running')
`)
...
module.exports = {
    ...
    updateClientSlots, deleteClient,
